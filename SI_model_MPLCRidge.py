# -*- coding: utf-8 -*-
from SI_model_MPLC_model import SI_model_MPLC_model
...
class SI_model(SI_model_base):
    ...
    def __init__(self, n_k=1, alpha=0):
        """
        Params:
            - n_k        : number of neighbors
    ...
    def fit(self,X_train,C_train,SI_train):
        ...
        return SI_model_MPLC_model.fit(self,X_train,C_train,SI_train,model)
    ...
    def predict(self,X_test,C_test,SI_test): 
        ...
        """
        return SI_model_MPLC_model.predict(self,X_test, C_test, SI_test)